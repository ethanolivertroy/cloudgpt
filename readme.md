...
## Credits ##
Originally based on work by [Mike Felch (@ustayready)](https://twitter.com/ustayready) - [Original Repository](https://github.com/ustayready/cloudgpt). This version has been significantly enhanced with Azure and GCP support, updated SDKs, and improved policy analysis. 
